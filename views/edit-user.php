...
// $user is ann associative array
// $user = ['id'] => 4, 'first_name' => 'asako', last_name => 'kimura', ..
...
<body>
    ...
    <main class="container" style="padding-top: 80px" >
        <div class="card w-50 mx-auto border-0">
            <div class="card-header bg-white border-white border-0">
            ...
            <form action="../actions/edit-user.php" method="post">
                <input type="hidden" name="id" value="<?= $_GET['user_id'] ?>">
                    ...
                    <input type="text" name="first_name" id="first" class="form-control mb-2" value="<?= $user['first_name'] ?>" required autofocus>

                    <label for="last-name" class="form-label">Last Name</label>
                    <input type="text" name="last_name" id="last_name" class="form-control mb-2" value="<?= $user['last_name'] ?>" required>
