        ...
        <div class="row h-100 m-0">
            <div class="card w-25 my-auto mx-auto">
                ...
                <form action="../actions/register.php" method="post"> 
                    <!-- access to action/register.php -->
                    <div class="card-body">
                        <label for="first-name" class="form-label">First Name</label>
                        <input type="text" name="first_name" id="first" class="form-control mb-2" required autofocus>
                        ...
                        <input type="password" name="password" id="password" class="form-control mb-5 fw-bold" minlength="8" required>
